...
import com.example.myapplication.databinding.BundesligaBinding;
...
public class BundesligaFragment extends Fragment {
    ...
    private BundesligaBinding binding;
    ...
    public View onCreateView(
        ...
        binding = BundesligaBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(BundesligaFragment.this)
                        .navigate(R.id.action_bundesligaFragment_to_HomepageFragment);
            }
        });
        ...
        binding.button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(BundesligaFragment.this)
                        .navigate(R.id.action_bundesligaFragment_self);
            }
        });
    }
    ...
    public void startAsyncTask(View view, String dataDetail) {
        if (dataDetail.equals("matches")) {
            ...
            leaguesAsyncTask.execute("matches", "bundesliga");
            ...
            leaguesAsyncTask.execute("standing", "bundesliga");
            try {
