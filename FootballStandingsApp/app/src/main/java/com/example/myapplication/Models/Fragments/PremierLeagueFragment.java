...
import com.example.myapplication.databinding.PremierLeagueBinding;
...
public class PremierLeagueFragment extends Fragment {
    ...
    private PremierLeagueBinding binding;
    ...
    public View onCreateView(
        ...
        binding = PremierLeagueBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(PremierLeagueFragment.this)
                        .navigate(R.id.action_PremierLeagueFragment_to_HomepageFragment);
            }
        });
        ...
        binding.button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(PremierLeagueFragment.this)
                        .navigate(R.id.action_PremierLeagueFragment_self);
            }
        });
    }
    ...
    public void startAsyncTask(View view, String dataDetail) {
        if(dataDetail.equals("matches")){
            ...
            leaguesAsyncTask.execute("matches","premier_league");
            ...
            leaguesAsyncTask.execute("standing", "premier_league");
            try {
